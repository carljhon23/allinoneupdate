...
module.exports = {
    ...
    async execute(interaction) {
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            if (subcommand === 'set') {
                // Check if the user has Administrator permission only
                ...
                // Administrator permission was already checked above, so we can proceed directly
                // No need for additional owner or bot manager checks
